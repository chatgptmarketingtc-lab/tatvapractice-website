...
const CORE_FEATURES = [
  { icon: '🔄', title: 'Real-Time Sync', description: 'Changes propagate instantly across all connected devices. Update a patient record on your phone, and it appears on your desktop within milliseconds.' },
  { icon: '📴', title: 'Offline-First Architecture', description: 'Work without internet — SmartSync queues all changes locally and resolves conflicts intelligently when connectivity returns. Zero data loss, guaranteed.' },
  { icon: '🏛️', title: 'ABDM Integration', description: 'Seamlessly syncs patient records with the Ayushman Bharat Digital Mission ecosystem, including ABHA IDs, health lockers, and consent-based data exchange.' },
  { icon: '💾', title: 'Auto-Backup & Recovery', description: 'Continuous encrypted backups to the cloud with point-in-time recovery. Restore your entire practice data from any moment in the last 90 days.' },
  { icon: '🔒', title: 'End-to-End Encryption', description: 'AES-256 encryption at rest and TLS 1.3 in transit. Your patient data is encrypted before it leaves the device and remains encrypted in the cloud.' },
  { icon: '🏥', title: 'Multi-Location Support', description: 'Sync data across multiple clinic branches seamlessly. Staff at one location can access shared patient records from any other branch in real-time.' },
];
  ...
  return (
    <>
      ...
      <HeroSection
        ...
        visual={<ProductHeroVisual icon="🔄" name="SmartSync" desc="Seamless Data Synchronization" pills={['Real-Time', 'Offline-First', 'Encrypted', 'ABDM Ready']} />}
      />
        ...
        <div className="max-w-container mx-auto px-8">
          ...
          <ScrollReveal variant="stagger">
            <div className="grid md:grid-cols-3 gap-6">
              {[
                { icon: '🏠', title: 'Solo Practitioners', desc: 'Sync between your clinic desktop and personal phone. Access patient records on the go, even during home visits without internet.' },
                { icon: '🏥', title: 'Multi-Branch Clinics', desc: 'Shared patient database across branches with centralized reporting. Staff at any location can pull up records instantly.' },
                { icon: '🚑', title: 'Field & Camp Settings', desc: 'Offline-first design ensures full functionality at health camps, rural outreach, and mobile clinics with intermittent connectivity.' },
              ].map((item, i) => (
