...
const CORE_FEATURES = [
  { icon: '🧬', title: 'Differential Diagnosis Engine', description: 'Enter symptoms, vitals, and history — get a ranked list of differential diagnoses with probability scores, supporting evidence, and recommended workup for each.' },
  { icon: '⚠️', title: 'Drug Interaction Alerts', description: 'Real-time screening of all prescribed medications against a comprehensive interaction database. Flags contraindications, duplicate therapies, and dosage concerns before you finalize.' },
  { icon: '🔬', title: 'Lab Report Interpretation', description: 'Upload lab reports and get AI-powered interpretation with clinical context — abnormal values highlighted, trends tracked over time, and differential implications explained.' },
  { icon: '📚', title: 'Evidence-Based Suggestions', description: 'Treatment suggestions linked to current clinical guidelines, peer-reviewed literature, and Indian medical protocols. Every recommendation comes with a citation trail.' },
  { icon: '📊', title: 'Patient Risk Scoring', description: 'Continuous risk stratification using patient history, comorbidities, medications, and lab trends. Proactively identifies patients who need closer monitoring.' },
  { icon: '💬', title: 'Clinical Query Assistant', description: 'Ask clinical questions in natural language and get evidence-backed answers instantly. From drug dosages to diagnostic criteria — your medical knowledge base at hand.' },
];
  ...
  return (
    <>
      ...
      <HeroSection
        ...
        visual={<ProductHeroVisual icon="🧠" name="Doctor Agent" desc="AI Clinical Assistant" pills={['DDx Engine', 'Drug Alerts', 'Lab AI', 'Evidence-Based']} />}
      />
        ...
        <div className="max-w-container mx-auto px-8">
          ...
          <ScrollReveal variant="stagger">
            <div className="grid md:grid-cols-3 gap-6">
              {[
                { icon: '🩺', title: 'Complex Differentials', desc: 'A patient presents with atypical chest pain. Doctor Agent ranks cardiac, GI, musculoskeletal, and anxiety-related causes by probability, suggesting targeted workup for each.' },
                { icon: '💊', title: 'Polypharmacy Safety', desc: 'An elderly patient on 8+ medications. Doctor Agent screens every new prescription against existing drugs, flagging interactions the busiest clinician might miss.' },
                { icon: '🔬', title: 'Lab Trend Analysis', desc: 'HbA1c trending upward over three visits. Doctor Agent highlights the trend, correlates with current medications, and suggests guideline-based escalation options.' },
              ].map((item, i) => (
