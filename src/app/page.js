...
const MANAGEMENT_FEATURES = [
  { icon: <CalendarCheck size={22} strokeWidth={1.5} className="text-white/90" />, title: 'Appointments', description: 'Smart scheduling with automated reminders and calendar sync for seamless patient management.' },
  { icon: <Pill size={22} strokeWidth={1.5} className="text-white/90" />, title: 'Prescriptions', description: 'AI-powered prescription writing in seconds with VoiceRx, SnapRx, and AmbientRx modes.' },
  { icon: <Receipt size={22} strokeWidth={1.5} className="text-white/90" />, title: 'Billing & Invoicing', description: 'Automated billing, GST invoicing, and payment tracking with integrated payment gateway.' },
  { icon: <BarChart3 size={22} strokeWidth={1.5} className="text-white/90" />, title: 'Reports & Analytics', description: 'Comprehensive dashboards with patient trends, revenue insights, and practice performance.' },
  { icon: <FolderHeart size={22} strokeWidth={1.5} className="text-white/90" />, title: 'Patient Records', description: 'Complete digital health records with ABDM integration and longitudinal patient history.' },
  { icon: <BellRing size={22} strokeWidth={1.5} className="text-white/90" />, title: 'Notifications & Recalls', description: 'Automated follow-up reminders, vaccination alerts, and patient engagement campaigns.' },
];

const EHR_FEATURES = [
  { icon: <NotebookPen size={20} strokeWidth={1.5} className="text-purple-600" />, title: 'Clinical Notes', description: 'SOAP notes, templates, and auto-generated documentation from voice or ambient capture.' },
  { icon: <Syringe size={20} strokeWidth={1.5} className="text-purple-600" />, title: 'Vaccination Tracker', description: 'Complete immunization schedules with automated reminders for patients and providers.' },
  { icon: <Microscope size={20} strokeWidth={1.5} className="text-purple-600" />, title: 'Lab Integration', description: 'Direct lab ordering, result tracking, and AI-powered interpretation of reports.' },
  { icon: <Video size={20} strokeWidth={1.5} className="text-purple-600" />, title: 'Telehealth', description: 'Built-in video consultations with digital prescription and payment integration.' },
];
...
const PRACTICE_SIZES = [
  {
    icon: <Stethoscope size={40} strokeWidth={1.5} className="text-purple-600" />,
  ...
  {
    icon: <Building2 size={40} strokeWidth={1.5} className="text-purple-600" />,
...
export default function HomePage() {
  return (
    <>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {MANAGEMENT_FEATURES.map((f, i) => (
                <div key={i} className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 border border-white/10 hover:bg-white/10 transition-colors text-left">
                  <div className="w-12 h-12 rounded-xl bg-white/10 backdrop-blur-sm border border-white/10 transition-colors duration-200 group-hover:bg-white/15 flex items-center justify-center mb-4">{f.icon}</div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {EHR_FEATURES.map((f, i) => (
              <div key={i} className="bg-white rounded-2xl p-6 border border-black/5 shadow-sm hover:shadow-md transition-shadow text-center">
                <div className="w-11 h-11 rounded-xl bg-purple-50 border border-purple-100 transition-colors duration-200 flex items-center justify-center mx-auto mb-4">{f.icon}</div>
      ...
      <UseCaseSection
        reverse
        icon={<Stethoscope size={20} strokeWidth={1.5} className="text-white" />}
        name="Workflows"
